...
public class UpdateCatalogueIntegrationTest {
    ...
    void IntegrationTest_UpdateCatalogueNullRequestObject(){
        ...
        assertThrows(cs.superleague.shopping.exceptions.InvalidRequestException.class, ()-> {
            UpdateCatalogueResponse updateCatalogueResponse = ServiceSelector.getShoppingService().updateCatalogue(updateCatalogueRequest);
        });
    }
    ...
    void IntegrationTest_Store_does_exist_changing_catalogue() throws InvalidRequestException, StoreDoesNotExistException {
        updateCatalogueRequest=new UpdateCatalogueRequest(catalogue2);
        UpdateCatalogueResponse response= ServiceSelector.getShoppingService().updateCatalogue(updateCatalogueRequest);
