...
public class UpdateStoreIntegrationTest {
    ...
    void IntegrationTest_UpdateStoreNullRequestObject(){
        ...
        assertThrows(cs.superleague.shopping.exceptions.InvalidRequestException.class, ()-> {
            UpdateStoreResponse updateStoreResponse = ServiceSelector.getShoppingService().updateStore(updateStoreRequest);
        });
    }
    ...
    void IntegrationTest_Store_does_exist_updating_store() throws InvalidRequestException, StoreDoesNotExistException {
        updateStoreRequest = new UpdateStoreRequest(store2);
        UpdateStoreResponse response= ServiceSelector.getShoppingService().updateStore(updateStoreRequest);
