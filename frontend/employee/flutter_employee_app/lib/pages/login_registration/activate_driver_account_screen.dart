...
class ActivateDriverAccountScreen extends StatefulWidget {
  @override
  _ActivateDriverAccountState createState() => _ActivateDriverAccountState();
}

class _ActivateDriverAccountState extends State<ActivateDriverAccountScreen> {
  ...
  Widget _popUpSuccessfulActivation(BuildContext context) {
    return new AlertDialog(
      ...
      actions: <Widget>[
        new FlatButton(
          onPressed: () {
            MyNavigator.goToDriverIntro(context);
          },
                ...
                child: Column(
                  children: <Widget>[
                    Column(children: <Widget>[
                      Text(
                        'Enter the email address and activation code associated with your driver account.',
                        style: TextStyle(
                            fontSize: 23.0,
                            fontWeight: FontWeight.bold,
