...
class _DriverWorkScreenState extends State<DriverWorkScreen> {
        ...
        children: <Widget>[
          ...
          _isOne
              ...
              : Text(
                  "There are " +
                      (_isTwo ? "2" : "3") +
                      " stores to collect from",
                  textAlign: TextAlign.center),
          Text("\n Accept it?", textAlign: TextAlign.center),
        ],
      ),
        ...
        new FlatButton(
          onPressed: () async {
            await _deliveryService
                .assignDriverToDelivery(_delivery.deliveryID, context)
                .then((value) => {
                      setState(() {
                        if (value == true) {
                          _isDelivery = true;
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text("Could not get delivery")));
  ...
  Widget _popUpGoToMap(BuildContext context) {
    return new AlertDialog(
      ...
      content: new Column(
        ...
        children: <Widget>[
          Text("Go to map to get direction ", textAlign: TextAlign.center),
        ],
      ),
      actions: <Widget>[
        new FlatButton(
          onPressed: () async {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) =>
                    DriverHomeScreen(0) //ProductPage(product: product),
                ));
          },
  ...
  void setDelivery() async {
    Delivery delivery =
        await Provider.of<DeliveryProvider>(context, listen: false).delivery;
              ...
              Column(
                children: [
                                                            ...
                                                            if (_isDelivery)
                                                              {
                                                                ScaffoldMessenger.of(
                                                                    ...
                                                                    .showSnackBar(SnackBar(
                                                                        content:
                                                                            Text("Please complete trip before ending shift")))
                                                              }
                                                            else if (value ==
                                                                true)
                                                              {
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: Image(
                                            ...
                                            image: _onShift
                                                ? AssetImage(
                                                    'assets/gifs/deliveryTruck.gif')
                                                : AssetImage(
                                                    'assets/delivery/staticDeliveryTruck.png'),
                                          ),
                                        ),
                                        SizedBox(
                                          height: 5,
                  ...
                  Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _isDelivery == false || _onShift == false
                          ? Container(
                              height: 320.0,
                              child: Row(
                                children: <Widget>[
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        child: Text(
                                          _isOne
                                              ? "Store's pickup address: "
                                              : "First Store's address: ",
                                          style: kTitleTextStyle.copyWith(
                                              fontWeight: FontWeight.w400,
                                              fontSize: 14),
                                        ),
                        ...
                        ? RaisedButton(
                            onPressed: () async {
                              if (_isDelivery) {
                                ...
                                } else if (_startedDeliveringToCustomer ==
                                    false) {
                                  await _deliveryService.UpdateDeliveryStatus(
                                          deliveryID,
