...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  Widget _dropDown() {
    return Column(
      children: [
        Text("Type of Report", textAlign: TextAlign.center,
              ...
              child: DropdownButton<String>(
                ...
                items: <String>[
                  ...
                  return DropdownMenuItem<String>(
                    ...
                    child: SizedBox(
                        width: 90,
                        child: Text(value, style: TextStyle(color: Colors.white),textAlign: TextAlign.end)),
                  );
                }).toList(),
                hint: Text(
                  "Choose report type",
  ...
  mainAxisAlignment: MainAxisAlignment.center,
    ...
    onPressed: () async {
      ...
      String startDate=_dateTimeStart.year.toString()+"/"+startMonth+"/"+startDay+" 00:00:00";
      String endDate=_dateTimeEnd.year.toString()+"/"+endMonth+"/"+endDay+" 00:00:00";
      if(_chosenValue=="PDF" && selected==0){
        setState(() {
          _isInAsyncCall=true;
        });
        await _analyticsService.createFinancialPDFReport(context,startDate,endDate).then((value) =>
          {
            if(value!=null){
              saveAndLaunchPDFFile(context,value, "financialReport.pdf")
            },
            setState(() {
        ...
        await _analyticsService.createFinancialCSVReport(context,startDate,endDate).then((value) =>
        {
          if(value!=null){
        ...
        await _analyticsService.createMonthlyPDFReport(context).then((value) =>
        {
          if(value!=null){
            saveAndLaunchPDFFile(context,value, "monthlyReport.pdf")
          },
          setState(() {
            _isInAsyncCall=false;
          })
        ...
        await _analyticsService.createMonthlyCSVReport(context).then((value) =>
        {
          if(value!=null){
            saveCSVFile(context,value, "financialReport.csv"),
        ...
        await _analyticsService.createUserPDFReport(context,startDate,endDate).then((value) =>
        {
          if(value!=null){
