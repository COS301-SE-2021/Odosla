...
class _ImporterScreenState extends State<ImporterScreen> {
  ...
  final List<String> _listOfRoles = <String>["STORE", "ITEMS"];
        ...
        onPressed: () async {
          ...
          if (currentCSV == null) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text("Something went wrong with processing CSV")));
          } else if (selected == 1) {
            setState(() {
              _isInAsyncCall = true;
            });
                  ...
                  if (value == true)
                    {
                      setState(() {
                        ...
                        picked = null;
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Successfully imported Items")));
                      })
                    }
                });
            setState(() {
                  ...
                  if (value == true)
                    {
                      setState(() {
                        ...
                        picked = null;
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Successfully imported Stores")));
                      })
                    }
                });
            setState(() {
