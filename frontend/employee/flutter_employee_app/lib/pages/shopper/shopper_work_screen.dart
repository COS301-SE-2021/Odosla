    ...
    if (_onShift == true) {
      if (Provider.of<ShopProvider>(context, listen: false).store.imageUrl ==
        ...
        if (Provider.of<ShopProvider>(context, listen: false).store.id != "") {
          _shoppingService.getStoreByID(context,
                ...
                if (value == null)
                  {
                    ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("Could not retrieve order")))
                  }
                else
                  {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) =>
                            CurrentOrderScreen(context, store: _store)))
                  }
              });
        },
                ...
                await Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => BarcodeScanPage(
                            ...
                            productName: text,
                            brand: brand,
                            store: Provider.of<ShopProvider>(context,
                                    listen: false)
                                .store,
                          )),
                ).then((value) => {
  ...
  Widget _notCurrentOrder() {
    return Column(
      ...
      children: [
        ...
        Text(
          _onShift ? "NOT PACKING AN ORDER" : "NOT ON SHIFT",
          style: TextStyle(
        ...
        Text(
          _onShift
              ? "Start packing order by clicking below"
                                  ...
                                  Container(
                                    ...
                                    child: Image(
                                      ...
                                      image: _onShift
                                          ...
                                          : AssetImage(
                                              'assets/shopping/staticShoppingCart.png'),
                                    ),
                                  ),
                                  SizedBox(
                                    height: 5,
                  ...
                  _isCurrentOrder
                      ? Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Store _store = Provider.of<ShopProvider>(context,
                                      listen: false)
                                  .store;
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      CurrentOrderScreen(context,
                                          store: _store)));
                            },
                            child: Icon(
