...
class AnalyticsService {
  ...
  Future<String?> createFinancialCSVReport(
      BuildContext context, String startDate, String endDate) async {
    final url =
        Uri.parse(analyticsEndPoint + "analytics/createFinancialReport");
  ...
  Future<List<int>?> createFinancialPDFReport(
      BuildContext context, String startDate, String endDate) async {
    final url =
        Uri.parse(analyticsEndPoint + "analytics/createFinancialReport");
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData["success"] == true) {
        PdfDocument document =
            PdfDocument.fromBase64String(responseData["pdf"]);
  ...
  Future<String?> createUserCSVReport(
      BuildContext context, String startDate, String endDate) async {
  ...
  Future<List<int>?> createUserPDFReport(
      BuildContext context, String startDate, String endDate) async {
    final url = Uri.parse(analyticsEndPoint + "analytics/createUserReport");
