...
import cs.superleague.models.UserCompleteDeliveryRequest;
import cs.superleague.models.UserCompleteDeliveryResponse;
...
import cs.superleague.models.UserDriverSetRatingRequest;
import cs.superleague.models.UserDriverSetRatingResponse;
import cs.superleague.models.UserGetCurrentUserRequest;
import cs.superleague.models.UserGetCurrentUserResponse;
import cs.superleague.models.UserGetCustomerByUUIDRequest;
import cs.superleague.models.UserGetCustomerByUUIDResponse;
...
import cs.superleague.models.UserUpdateAdminDetailsRequest;
import cs.superleague.models.UserUpdateAdminDetailsResponse;
import cs.superleague.models.UserUpdateCustomerDetailsRequest;
import cs.superleague.models.UserUpdateCustomerDetailsResponse;
import cs.superleague.models.UserUpdateDriverDetailsRequest;
import cs.superleague.models.UserUpdateDriverDetailsResponse;
import cs.superleague.models.UserUpdateDriverShiftRequest;
import cs.superleague.models.UserUpdateDriverShiftResponse;
import cs.superleague.models.UserUpdateShopperDetailsRequest;
import cs.superleague.models.UserUpdateShopperDetailsResponse;
...
public interface UserApi {
    ...
    @ApiOperation(value = "Endpoint for complete delivery use case", nickname = "completeDelivery", notes = "Refer to summary", response = UserCompleteDeliveryResponse.class, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns delivery is completed", response = UserCompleteDeliveryResponse.class) })
    @RequestMapping(value = "/user/completeDelivery",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserCompleteDeliveryResponse> completeDelivery(@ApiParam(value = "The input body required by this request" ,required=true )  @Valid @RequestBody UserCompleteDeliveryRequest body
);
    ...
    @ApiOperation(value = "Endpoint for setting rating use case", nickname = "driverSetRating", notes = "Refer to summary", response = UserDriverSetRatingResponse.class, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns response", response = UserDriverSetRatingResponse.class) })
    @RequestMapping(value = "/user/driverSetRating",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserDriverSetRatingResponse> driverSetRating(@ApiParam(value = "The input body required by this request" ,required=true )  @Valid @RequestBody UserDriverSetRatingRequest body
);
    ...
    @ApiOperation(value = "Endpoint for get customer by UUID use case", nickname = "getCustomerByUUID", notes = "Refer to summary", response = UserGetCustomerByUUIDResponse.class, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns customer", response = UserGetCustomerByUUIDResponse.class) })
    @RequestMapping(value = "/user/getCustomerByUUID",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserGetCustomerByUUIDResponse> getCustomerByUUID(@ApiParam(value = "The input body required by this request" ,required=true )  @Valid @RequestBody UserGetCustomerByUUIDRequest body
);
    ...
    @ApiOperation(value = "Endpoint for updating admin details", nickname = "updateAdminDetails", notes = "Refer to summary", response = UserUpdateAdminDetailsResponse.class, tags={ "User", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns if updating details was successful", response = UserUpdateAdminDetailsResponse.class) })
    @RequestMapping(value = "/user/updateAdminDetails",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserUpdateAdminDetailsResponse> updateAdminDetails(@ApiParam(value = "The input body require by this request" ,required=true )  @Valid @RequestBody UserUpdateAdminDetailsRequest body
);


    @ApiOperation(value = "Endpoint for updating customer details", nickname = "updateCustomerDetails", notes = "Refer to summary", response = UserUpdateCustomerDetailsResponse.class, tags={ "User", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns if updating details was successful", response = UserUpdateCustomerDetailsResponse.class) })
    @RequestMapping(value = "/user/updateCustomerDetails",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserUpdateCustomerDetailsResponse> updateCustomerDetails(@ApiParam(value = "The input body require by this request" ,required=true )  @Valid @RequestBody UserUpdateCustomerDetailsRequest body
);


    @ApiOperation(value = "Endpoint for updating driver details", nickname = "updateDriverDetails", notes = "Refer to summary", response = UserUpdateDriverDetailsResponse.class, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns if updating details was successful", response = UserUpdateDriverDetailsResponse.class) })
    @RequestMapping(value = "/user/updateDriverDetails",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserUpdateDriverDetailsResponse> updateDriverDetails(@ApiParam(value = "The input body require by this request" ,required=true )  @Valid @RequestBody UserUpdateDriverDetailsRequest body
);
    ...
    @ApiOperation(value = "Endpoint for updating shopper details", nickname = "updateShopperDetails", notes = "Refer to summary", response = UserUpdateShopperDetailsResponse.class, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Returns if updating details was successful", response = UserUpdateShopperDetailsResponse.class) })
    @RequestMapping(value = "/user/updateShopperDetails",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<UserUpdateShopperDetailsResponse> updateShopperDetails(@ApiParam(value = "The input body require by this request" ,required=true )  @Valid @RequestBody UserUpdateShopperDetailsRequest body
);
