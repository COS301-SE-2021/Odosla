...
public class AddToQueueIntegrationTest {
    ...
    void setUp(){
        ...
        order = new Order(expectedOrderId, expectedUserId, expectedStoreId, expectedShopperId,
                new Date(), null, expectedtotalCost, OrderType.DELIVERY, OrderStatus.PURCHASED, expectedDiscount, null, null, false);
