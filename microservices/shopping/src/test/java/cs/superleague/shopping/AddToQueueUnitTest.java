...
public class AddToQueueUnitTest {
    ...
    void setUp() {
        ...
        c1=new CartItem("Heinz Tomato Sauce","p123456","b123456",uuid,36.99,1,"description","img/");
        i2=new Item("Ice Cream","p012345","b012345",uuid,14.99,3,"description","img/");
        c2=new CartItem("Ice Cream","p012345","b012345",uuid,14.99,3,"description","img/");
        listOfItems.add(i1);
        listOfItems.add(i2);
        ...
        // add cartitems
        order = new Order(uuid, uuid, uuid, uuid, new Date(), new Date(), 30.0, OrderType.DELIVERY, OrderStatus.PURCHASED, 0.0, null, null, false);
