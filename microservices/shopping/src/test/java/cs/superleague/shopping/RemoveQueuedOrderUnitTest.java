...
public class RemoveQueuedOrderUnitTest {
    ...
    void setUp() {
        ...
        c1=new CartItem("Heinz Tomato Sauce","123456","123456",storeUUID1,36.99,1,"description","img/");
        ...
        o=new Order(o1UUID, expectedU1, expectedS1, expectedShopper1, new Date(), d1, totalC, OrderType.DELIVERY,
                OrderStatus.AWAITING_PAYMENT, expectedDiscount, deliveryAddress, storeAddress, false);
        o2=new Order(o2UUID,expectedU1, expectedS1, expectedShopper1, new Date(), d2, totalC, OrderType.DELIVERY, OrderStatus.AWAITING_PAYMENT, expectedDiscount, deliveryAddress, storeAddress, false);
