...
public class RegisterAdminUnitTest {
    ...
    void UnitTest_ValidRegistration() throws InvalidRequestException {
        ...
        parts.put("message", "Please use the following activation code to activate your account ");
        parts.put("properties", properties);
        SendDirectEmailNotificationResponse sendDirectEmailNotificationResponse = new SendDirectEmailNotificationResponse(true, "success");
        ResponseEntity<SendDirectEmailNotificationResponse> getStoresResponseEntity = new ResponseEntity<>(sendDirectEmailNotificationResponse, HttpStatus.OK);
                restTemplate.postForEntity("http://"+notificationHost+":"+notificationPort+"/notification/sendDirectEmailNotification", properties, SendDirectEmailNotificationResponse.class);
