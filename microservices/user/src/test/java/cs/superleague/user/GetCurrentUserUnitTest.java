...
public class GetCurrentUserUnitTest {
    ...
    void UnitTest_CustomerNotRetrieved() throws InvalidRequestException {
        ...
        when(jwtUtil.extractUserType(jwtTokenCustomer.replace("Bearer ",""))).thenReturn(String.valueOf(UserType.CUSTOMER));
        when(jwtUtil.extractEmail(jwtTokenCustomer.replace("Bearer ",""))).thenReturn(customerEmail);
    ...
    void UnitTest_ShopperNotRetrieved() throws InvalidRequestException {
        ...
        when(jwtUtil.extractUserType(jwtTokenShopper.replace("Bearer ",""))).thenReturn(String.valueOf(UserType.SHOPPER));
        when(jwtUtil.extractEmail(jwtTokenShopper.replace("Bearer ",""))).thenReturn(shopperEmail);
    ...
    void UnitTest_DriverNotRetrieved() throws InvalidRequestException {
        ...
        when(jwtUtil.extractUserType(jwtTokenDriver.replace("Bearer ",""))).thenReturn(String.valueOf(UserType.DRIVER));
        when(jwtUtil.extractEmail(jwtTokenDriver.replace("Bearer ",""))).thenReturn(driverEmail);
        GetCurrentUserResponse response= userService.getCurrentUser(validRequest);
    ...
    void UnitTest_AdminNotRetrieved() throws InvalidRequestException {
        ...
        when(jwtUtil.extractUserType(jwtTokenAdmin.replace("Bearer ",""))).thenReturn(String.valueOf(UserType.ADMIN));
        when(jwtUtil.extractEmail(jwtTokenAdmin.replace("Bearer ",""))).thenReturn(adminEmail);
        GetCurrentUserResponse response= userService.getCurrentUser(validRequest);
