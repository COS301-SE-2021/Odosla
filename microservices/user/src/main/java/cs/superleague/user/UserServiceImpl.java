                ...
                case SHOPPER:
                    ...
                    if (shopperToVerify.getActivationDate() == null) {
                        ...
                        if (shopperToVerify.getActivationCode().equals(request.getActivationCode())) {
                            ...
                            return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Activation code was incorrect", UserType.SHOPPER);
                    } else
                        return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Shopper with email '" + request.getEmail() + "' has already activated their Shopper account", UserType.SHOPPER);
                ...
                case DRIVER:
                    ...
                    if (driverToVerify.getActivationDate() == null) {
                        ...
                        if (driverToVerify.getActivationCode().equals(request.getActivationCode())) {
                            ...
                            return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Activation code was incorrect", UserType.DRIVER);
                    } else
                        return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Driver with email '" + request.getEmail() + "' has already activated their Driver account", UserType.DRIVER);
                ...
                case CUSTOMER:
                    ...
                    if (customerToVerify.getActivationDate() == null) {
                        ...
                        if (customerToVerify.getActivationCode().equals(request.getActivationCode())) {
                            ...
                            return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Activation code was incorrect", UserType.CUSTOMER);
                    } else
                        return new AccountVerifyResponse(false, Calendar.getInstance().getTime(), "Customer with email '" + request.getEmail() + "' has already activated their Customer account", UserType.CUSTOMER);
        ...
        if (request != null) {
            ...
            switch (userType) {
                ...
                case "SHOPPER":
                    //assert shopperRepo!=null;
                    try {
                        user = shopperRepo.findByEmail(email).orElse(null);
                    } catch (Exception e) {
                    }
