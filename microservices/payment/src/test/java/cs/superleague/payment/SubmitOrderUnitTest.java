...
public class SubmitOrderUnitTest {
    ...
    void UnitTest_testingNull_listOfItems_Parameter_RequestObject(){
        SubmitOrderRequest request=new SubmitOrderRequest(null,0.0, UUID.randomUUID(), null, null,  OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
    ...
    void UnitTest_testingNull_discount_Parameter_RequestObject(){
        ...
        SubmitOrderRequest request=new SubmitOrderRequest(list,null, UUID.randomUUID(), null, null,  OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        Throwable thrown = Assertions.assertThrows(InvalidRequestException.class, ()-> paymentService.submitOrder(request));
    ...
    void UnitTest_testingNull_storeID_Parameter_RequestObject(){
        List<CartItem> list=new ArrayList<>();
        SubmitOrderRequest request=new SubmitOrderRequest(list,0.0, null, null, null,  OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        Throwable thrown = Assertions.assertThrows(InvalidRequestException.class, ()-> paymentService.submitOrder(request));
    ...
    void UnitTest_testingNull_orderType_Parameter_RequestObject(){
        List<CartItem> list=new ArrayList<>();
        SubmitOrderRequest request=new SubmitOrderRequest(list,0.0, UUID.randomUUID(), null, null,  null, 3.3, 3.5, "Homer Street");
        Throwable thrown = Assertions.assertThrows(InvalidRequestException.class, ()-> paymentService.submitOrder(request));
    ...
    void UnitTest_testingNull_storeAddress_Parameter_RequestObject(){
        List<CartItem> list=new ArrayList<>();
        SubmitOrderRequest request=new SubmitOrderRequest(list,0.0, UUID.randomUUID(), null, null,  OrderType.DELIVERY, 3.3, 3.5, null);
        Throwable thrown = Assertions.assertThrows(InvalidRequestException.class, ()-> paymentService.submitOrder(request));
    ...
    void UnitTest_SubmitOrderRequestConstruction() {
        ...
        SubmitOrderRequest request=new SubmitOrderRequest(cartItems,expectedDiscount,expectedS1, null, null, expectedType, 3.3, 3.5, "Homer Street");

        assertNotNull(request);
        assertEquals(cartItems,request.getListOfItems());
        assertEquals(expectedDiscount,request.getDiscount());
        assertEquals(expectedS1,request.getStoreIDOne());
