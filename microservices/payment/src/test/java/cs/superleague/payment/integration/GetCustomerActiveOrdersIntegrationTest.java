...
//        rabbitTemplate.setChannelTransacted(true);
    ...
    void customerHasNoOrdersInDatabase_IntegrationTest() throws InvalidRequestException, OrderDoesNotExist, URISyntaxException {
...
//        assertEquals(response.getOrderID(), null);
    ...
    void customerHasNoActiveOrdersInDatabase_IntegrationTest() throws InvalidRequestException, OrderDoesNotExist, URISyntaxException {
//        order.setUserID(customerID);
//        order2.setUserID(customerID);
...
//        assertEquals(response.getOrderID(), null);
    ...
    void orderSuccessfullyReturnedToTheCustomer_IntegrationTest() throws InvalidRequestException, UserDoesNotExistException, OrderDoesNotExist, URISyntaxException {
//        order.setUserID(customerID);
//        order2.setUserID(UUID.randomUUID());
