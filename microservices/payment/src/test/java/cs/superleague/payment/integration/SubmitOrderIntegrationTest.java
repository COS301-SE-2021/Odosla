...
public class SubmitOrderIntegrationTest {
    ...
    void setup(){
        ...
        rabbitTemplate.convertAndSend("UserEXCHANGE", "RK_SaveCustomerToRepo",
...
//        catalogueRepo.save(stock);
    ...
    void IntegrationTest_CreateOrderWithNullParamterRequest() throws InvalidRequestException {
        submitOrderRequest=new SubmitOrderRequest(null,3.0,storeID, null, null, OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        assertThrows(cs.superleague.payment.exceptions.InvalidRequestException.class, ()-> {
            SubmitOrderResponse submitOrderResponse = paymentService.submitOrder(submitOrderRequest);
        });

        submitOrderRequest=new SubmitOrderRequest(cartItems,null,storeID, null, null, OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        assertThrows(cs.superleague.payment.exceptions.InvalidRequestException.class, ()-> {
            SubmitOrderResponse submitOrderResponse = paymentService.submitOrder(submitOrderRequest);
        });

        submitOrderRequest=new SubmitOrderRequest(cartItems,3.0,null, null, null, OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        assertThrows(cs.superleague.payment.exceptions.InvalidRequestException.class, ()-> {
            SubmitOrderResponse submitOrderResponse = paymentService.submitOrder(submitOrderRequest);
        });

        submitOrderRequest=new SubmitOrderRequest(cartItems,3.0,storeID, null, null, null, 3.3, 3.5, "Homer Street");
        assertThrows(cs.superleague.payment.exceptions.InvalidRequestException.class, ()-> {
            SubmitOrderResponse submitOrderResponse = paymentService.submitOrder(submitOrderRequest);
        });
    }
    ...
    void IntegrationTest_SubmitOrderRequestConstruction() {
        ...
        submitOrderRequest=new SubmitOrderRequest(cartItems,3.0,storeID, null, null, OrderType.DELIVERY, 3.3, 3.5, "Homer Street");
        ...
        assertEquals(storeID,submitOrderRequest.getStoreIDOne());
